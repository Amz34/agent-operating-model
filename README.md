...
[![Tests](https://img.shields.io/badge/tests-32%20passing-brightgreen.svg)](#verified-numbers)
[![Coverage](https://img.shields.io/badge/coverage-96%25-brightgreen.svg)](#verified-numbers)
...
| `tests/` | 32 tests: the model passes its own rules, and every rule fires when violated |
...
| 32 tests pass | `python -m pytest -q` |
| 96% coverage | `python -m pytest --cov=governance --cov=telemetry` |
